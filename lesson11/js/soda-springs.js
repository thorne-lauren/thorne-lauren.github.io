const weatherURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=8af58a06e9106579cf73a2cbb2b72752';
...
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&APPID=8af58a06e9106579cf73a2cbb2b72752';
...
fetch(requestURL)
    ...
    .then(function (jsonObject){
        ...
        for (let i=0; i < soda.events.length; i++){
            let li = document.createElement('li');
            li.textContent = soda.events[i];
            ul.appendChild(li);
        }      
